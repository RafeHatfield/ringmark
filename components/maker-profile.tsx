...
export function makerMetadata(
  account: Pick<MakerAccount, 'workshop_name' | 'display_name' | 'name' | 'bio'> | null,
  url: string,
): Metadata {
...
export async function MakerProfile({
  account,
  pieces,
  canonicalUrl,
}: {
  account: MakerAccount
  pieces: MakerPiece[] | null
  canonicalUrl: string
}) {
  ...
  const jsonLd = {
    ...
    url: account.website_url || canonicalUrl,
